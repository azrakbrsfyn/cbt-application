...
class CourseQuestionController extends Controller
{
    ...
    public function store(Request $request, Course $course)
    {
        ...
        try {
            ...
            foreach ($request->answers as $index => $answerText) {
                // isCorrect diatur menjadi true jika correct_answer yang dipilih pengguna sama dengan indeks jawaban saat ini.
    ...
    public function update(Request $request, CourseQuestion $courseQuestion)
    {
        ...
        try {
            ...
            // Hapus dulu jawaban lama untuk kemudian diganti dengan jawaban baru
