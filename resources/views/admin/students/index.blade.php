        ...
        <div id="menu-content" class="flex flex-col w-full pb-[30px]">
            ...
            <div id="course-test" class="mx-[70px] w-[870px] mt-[30px]">
                ...
                <div class="flex flex-col gap-5 mt-2">
                    @forelse($students as $student)
                        <div
                            ...
                            <div class="flex items-center gap-[14px]">
                                @if ($student->status == 'Not Started Yet')
                                    <p
                                        class="p-[6px_10px] rounded-[10px] bg-[indigo] font-bold text-xs text-white outline-[indigo] outline-dashed outline-[2px] outline-offset-[4px] mr-[6px]">
                                        {{ $student->status }}</p>
                    ...
                    @empty
                        <p>
                            Belum ada siswa yang didaftarkan di dalam kelas ini. Silahkan menambahkan kelas terlebih
                            dahulu
                        </p>
                    @endforelse
                </div>
