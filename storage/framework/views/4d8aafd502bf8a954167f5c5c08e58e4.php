        ...
        <div id="menu-content" class="flex flex-col w-full pb-[30px]">
            ...
            <div class="header ml-[70px] pr-[70px] w-[940px] flex items-center justify-between mt-10">
                ...
                <div class="relative">
                    <a href="#" id="more-button"
                        ...
                        <img src="<?php echo e(asset('/images/icons/more.svg')); ?>" alt="icon">
                    </a>
                    <div
                        ...
                        <a href="<?php echo e(route('dashboard.course.course_students.create', $course)); ?>"
                        ...
                        <a href="" class="flex gap-[10px] items-center">
                            <div class="w-5 h-5">
                                <img src="<?php echo e(asset('/images/icons/note-favorite-outline.svg')); ?>" alt="icon">
                            </div>
                            <span class="font-semibold text-sm">Edit Course Details</span>
                        </a>
                        <a href="" class="flex gap-[10px] items-center">
                            <div class="w-5 h-5">
                                <img src="<?php echo e(asset('/images/icons/crown-outline.svg')); ?>" alt="icon">
                            </div>
            ...
            <div id="course-test" class="mx-[70px] w-[870px] mt-[30px]">
                ...
                <div class="flex flex-col gap-[30px] mt-2">
                    <a href="<?php echo e(route('dashboard.course.create.question', $course)); ?>"
                        class="w-full h-[92px] flex items-center justify-center p-4 border-dashed border-2 border-[#0A090B] rounded-[20px]">
                        <div class="flex items-center gap-5">
                            <div>
                                <img src="<?php echo e(asset('/images/icons/note-add.svg')); ?>" alt="icon">
                            </div>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div
                            ...
                            <div class="flex flex-col gap-[6px]">
                                ...
                                <p class="font-bold text-xl"><?php echo e($question->question); ?></p>
                            </div>
                            <div class="flex items-center gap-[14px]">
                                <a href="<?php echo e(route('dashboard.course_question.edit', $question)); ?>"
                                    class="bg-[#0A090B] p-[14px_30px] rounded-full text-white font-semibold">Edit</a>
                                <form method='POST'
                                    action="<?php echo e(route('dashboard.course_question.destroy', $question)); ?>">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
                                    <button
                                        class="w-[52px] h-[52px] flex shrink-0 items-center justify-center rounded-full bg-[#FD445E]">
                                        <img src="<?php echo e(asset('/images/icons/trash.svg')); ?>" alt="icon">
                                    </button>
                                </form>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div
                            ...
                            <div class="flex flex-col gap-[6px]">
                                <p class="text-[#7F8190]">Question</p>
                                <p class="font-bold text-xl">Tidak ada pertanyaan, buat pertanyaan baru</p>
                            </div>
                        </div>
                    <?php endif; ?>
                </div>
...
<?php /**PATH C:\Users\azrie\Desktop\cbt-bwa\resources\views/admin/courses/manage.blade.php ENDPATH**/ ?>