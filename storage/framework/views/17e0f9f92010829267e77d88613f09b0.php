                ...
                <ul class="flex flex-col gap-3">
                    ...
                    <li>
                        <a href=""
                            class="p-[10px_16px] flex items-center gap-[14px] rounded-full h-11 transition-all duration-300 hover:bg-[#2B82FE]">
                            <div>
                                <img src="<?php echo e(asset('/images/icons/crown.svg')); ?>" alt="icon">
                            </div>
...
<?php /**PATH C:\Users\azrie\Desktop\cbt-bwa\resources\views/students/courses/index.blade.php ENDPATH**/ ?>