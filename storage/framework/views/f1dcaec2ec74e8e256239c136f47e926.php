...
<body class="font-poppins text-[#0A090B]">
    <section id="content" class="flex">
        ...
        <div id="menu-content" class="flex flex-col w-full pb-[30px]">
            ...
            <form action="<?php echo e(route('dashboard.course.course_students.store', $course)); ?>" id="add-question"
                ...
                <div class="flex flex-col gap-[10px]">
                    ...
                    <div
                        ...
                        <div class="mr-[14px] w-6 h-6 flex items-center justify-center overflow-hidden">
                            <img src="<?php echo e(asset('/images/icons/sms.svg')); ?>" class="h-full w-full object-contain"
                                alt="icon">
                        </div>
                        <input type="text"
                            class="font-semibold placeholder:text-[#7F8190] placeholder:font-normal w-full outline-none"
...
<?php /**PATH C:\Users\azrie\Desktop\cbt-bwa\resources\views/admin/students/add_student.blade.php ENDPATH**/ ?>