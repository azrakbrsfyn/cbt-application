        ...
        <div id="menu-content" class="flex flex-col w-full pb-[30px]">
            ...
            <div class="flex flex-col px-5 mt-5">
                <div class="w-full flex justify-between items-center">
                    ...
                    <a href="<?php echo e(route('dashboard.courses.create')); ?>"
                        ...
                        <div class="flex shrink-0 w-[300px]">
                            <div class="flex items-center gap-4">
                                <div class="w-16 h-16 flex shrink-0 overflow-hidden rounded-full">
                                    <img src="<?php echo e(Storage::url($course->cover)); ?>" class="object-cover"
                                        alt="thumbnail">
                                </div>
                                <div class="flex flex-col gap-[2px]">
                                    <p class="font-bold text-lg"><?php echo e($course->name); ?></p>
                            ...
                            <div class="relative h-[41px]">
                                <div
                                    ...
                                    <button onclick="toggleMaxHeight(this)"
                                        ...
                                        menu
                                        <img src="<?php echo e(asset('/images/icons/arrow-down.svg')); ?>" alt="icon">
                                    </button>
                                    ...
                                    <a href="<?php echo e(route('dashboard.courses.edit', $course)); ?>"
                                        class="flex items-center justify-between font-bold text-sm w-full">
                                        Edit Course
                                    </a>
                                    <form method="post" action="<?php echo e(route('dashboard.courses.destroy', $course)); ?>">
                                        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\azrie\Desktop\cbt-bwa\resources\views/admin/courses/index.blade.php ENDPATH**/ ?>