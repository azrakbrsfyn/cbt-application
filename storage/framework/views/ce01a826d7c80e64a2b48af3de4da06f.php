...
<body class="font-poppins text-[#0A090B]">
    <section id="content" class="flex">
        ...
        <div id="menu-content" class="flex flex-col w-full pb-[30px]">
            ...
            <form method='POST' action="<?php echo e(route('dashboard.course.create.question.store', $course)); ?>"
                    ...
                    <?php for($i = 0; $i < 4; $i++): ?>
                        <div class="flex items-center gap-4">
                            ...
                            <label class="font-semibold flex items-center gap-[10px]"><input type="radio"
                                    value="<?php echo e($i); ?>" name="correct_answer"
                ...
                <button type='submit' href="course-details.html"
...
<?php /**PATH C:\Users\azrie\Desktop\cbt-bwa\resources\views/admin/questions/create.blade.php ENDPATH**/ ?>