...
<body class="font-poppins text-[#0A090B]">
    <section id="content" class="flex">
        ...
        <div id="menu-content" class="flex flex-col w-full pb-[30px]">
            ...
            <form method="post" enctype="multipart/form-data" action="<?php echo e(route('dashboard.courses.store')); ?>"
...
<?php /**PATH C:\Users\azrie\Desktop\cbt-bwa\resources\views/admin/courses/create.blade.php ENDPATH**/ ?>