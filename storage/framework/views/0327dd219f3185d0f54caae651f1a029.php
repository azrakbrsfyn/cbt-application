<!-- Tampilan untuk mengedit course -->

<!-- Tampilan untuk menambahkan course baru -->
    ...
    <section id="content" class="flex">
        ...
        <div id="menu-content" class="flex flex-col w-full pb-[30px]">
            ...
            <form method="post" enctype="multipart/form-data"
                action="<?php echo e(route('dashboard.courses.update', $course)); ?>"
                ...
                <div class="flex gap-5 items-center">
                    ...
                    <div class="relative w-[100px] h-[100px] rounded-full overflow-hidden">
                        <div class="relative file-preview z-10 w-full h-full">
                            <img src="<?php echo e(Storage::url($course->cover)); ?>"
                ...
                <div class="flex flex-col gap-[10px]">
                    ...
                    <div
                        ...
                        <div class="mr-[14px] w-6 h-6 flex items-center justify-center overflow-hidden">
                            <img src="<?php echo e(asset('images/icons/note-favorite-outline.svg')); ?>"
                                class="w-full h-full object-contain" alt="icon">
                        </div>
                        <input value = "<?php echo e($course->name); ?>" type="text"
                            class="font-semibold placeholder:text-[#7F8190] placeholder:font-normal w-full outline-none"
                ...
                <div class="group/category flex flex-col gap-[10px]">
                    ...
                    <div
                        ...
                        <div class="mr-[10px] w-6 h-6 flex items-center justify-center overflow-hidden">
                            <img src="<?php echo e(asset('images/icons/bill.svg')); ?>" class="w-full h-full object-contain"
                                alt="icon">
                        </div>
                        <select id="category_id"
                            class="pl-1 font-semibold focus:outline-none w-full text-[#0A090B] invalid:text-[#7F8190] invalid:font-normal appearance-none bg-[url('<?php echo e(asset('images/icons/arrow-down.svg')); ?>')] bg-no-repeat bg-right"
                            name="category_id" required>
                            <option value="<?php echo e($course->category->id); ?>" selected>
                                <?php echo e($course->category->name); ?></option>
                            <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <option value="<?php echo e($category->id); ?>" class="font-semibold"><?php echo e($category->name); ?>
                    ...
                    <div class="flex gap-5 items-center">
                        <a href="#"
                            ...
                            <div class="w-[70px] h-[70px] flex shrink-0 overflow-hidden">
                                <img src="<?php echo e(asset('images/icons/onboarding.svg')); ?>" class="w-full h-full"
                                    alt="icon">
                            </div>
                            ...
                            <div
                                ...
                                <img src="<?php echo e(asset('images/icons/tick-circle.svg')); ?>" alt="icon">
                            </div>
                        </a>
                        <a href="#"
                            class="group relative flex flex-col w-full items-center gap-5 p-[30px_16px] border border-[#EEEEEE] rounded-[30px] transition-all duration-300 aria-checked:border-2 aria-checked:border-[#0A090B]"
                            data-group="course-type" aria-checked="false" onclick="handleActiveAnchor(this)">
                            <div class="w-[70px] h-[70px] flex shrink-0 overflow-hidden">
                                <img src="<?php echo e(asset('images/icons/module.svg')); ?>" class="w-full h-full"
                                    alt="icon">
                            </div>
                        ...
                        <a href="#"
                            ...
                            data-group="course-type" aria-checked="false" onclick="handleActiveAnchor(this)">
                            <div class="w-[70px] h-[70px] flex shrink-0 overflow-hidden">
                                <img src="<?php echo e(asset('images/icons/job.svg')); ?>" class="w-full h-full" alt="icon">
                            </div>
                    ...
                    <div class="flex gap-[10px] items-center">
                        <a href="#"
                            ...
                            <div class="w-[24px] h-[24px] flex shrink-0 overflow-hidden">
                                <img src="<?php echo e(asset('images/icons/clock.svg')); ?>" class="w-full h-full"
                                    alt="icon">
                            </div>
                        ...
                        <a href="#"
                            ...
                            <div class="w-[24px] h-[24px] flex shrink-0 overflow-hidden">
                                <img src="<?php echo e(asset('images/icons/calendar-add-disabled.svg')); ?>"
                ...
                <div class="group/access flex flex-col gap-[10px]">
                    ...
                    <div
                        class="peer flex items-center p-[12px_16px] rounded-full border border-[#EEEEEE] transition-all duration-300 focus-within:border-2 focus-within:border-[#0A090B]">
                        <div class="mr-[10px] w-6 h-6 flex items-center justify-center overflow-hidden">
                            <img src="<?php echo e(asset('images/icons/security-user.svg')); ?>"
                                class="w-full h-full object-contain" alt="icon">
                        </div>
                        <select id="access"
                            class="pl-1 font-semibold focus:outline-none w-full text-[#0A090B] invalid:text-[#7F8190] invalid:font-normal appearance-none bg-[url('<?php echo e(asset('images/icons/arrow-down.svg')); ?>')] bg-no-repeat bg-right"
...
<?php /**PATH C:\Users\azrie\Desktop\cbt-bwa\resources\views/admin/courses/edit.blade.php ENDPATH**/ ?>